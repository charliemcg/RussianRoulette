...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final MediaPlayer emptyChamber = MediaPlayer.create(this, R.raw.emptychamber);//<-Empty chamber sound clip.
        ...
        chamberTextView.setText("Chambers: " + chambers.length);//<-Displays number of chambers to player.
        ...
        final Button multiButton = (Button) findViewById(R.id.multiPurposeButton);//<-This button is used to start game, reset game or pull trigger.
        multiButton.setText("Play");//<-Button text updates depending on what stage of the game the player is in.

        final boolean[] gamePlay = {false};//<-True when game is in play, false when game is not in play.
            ...
            public void onClick(View v) {
                if (gamePlay[0]){
                    ...
                    if (!chambers[i[0]]) {
                        ...
                        emptyChamber.start();
                        i[0]++;
                    //If chamber is loaded the player is informed of their death and the game is reset.
                    }else{
